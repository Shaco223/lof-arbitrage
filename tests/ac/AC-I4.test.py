...
Pass criteria: local smoke exits 0 and covers 4010 / 4001 / 4290 / success
with accepted == submitted count.
...
def test_ac_i4_ingest_payload_sample_matches_prd6_item_contract(project_root):
    ...
    assert len(snapshot["items"]) == _watchlist_size(project_root)
