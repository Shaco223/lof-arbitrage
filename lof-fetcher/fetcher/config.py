...
class Settings(BaseSettings):
    ...
    watchlist_path: Path = Field(default=Path("../assets/lof-watchlist-v2.csv"), alias="WATCHLIST_PATH")
    benchmark_mapping_path: Path = Field(default=Path("../assets/benchmark-mapping-v2.csv"), alias="BENCHMARK_MAPPING_PATH")
